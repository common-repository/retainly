...
class RAD_Rapidology extends RAD_Dashboard {
	...
	var $menu_page;
	var $protocol;
	var $privacy_url = 'https://blog.retainly.co/privacy-policy';
	var $tou_url = 'https://blog.retainly.co/terms-of-service';
	...
	function __construct() {
		...
		add_shortcode( 'rad_retainly_inline', array( $this, 'display_inline_shortcode' ) );
		add_shortcode( 'rad_retainly_locked', array( $this, 'display_locked_shortcode' ) );
	...
	function generate_new_account_form( $service, $account_name = '', $display_name = true ) {
		...
		$default_fields = sprintf( '
			...
			RAD_Rapidology::generate_hint( sprintf(
				'<a href="https://support.retainly.co" target="_blank">%1$s</a>',
